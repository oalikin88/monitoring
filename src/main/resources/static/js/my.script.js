...
function getFinalPage() {
    ...
    containerForPrinters.append(printerTitleRow);
    ...
    for (i = 0; i < printersArray.length; i++) {
        ...
        containerForPrinters.appendChild(paneObject);
    ...
    containerForCartridges.append(independedCartridgeTitleRow);
    ...
    for (i = 0; i < cartridgesArray.length; i++) {
        ...
        containerForCartridges.appendChild(paneObjectCartridge);
     ...
     if(!input.form.elements.amountPrinterInput.value) {
            containerForPrinters.hidden = true;
        }
        
        if(!input.form.elements.amountCartridgeInput.value) {
            containerForCartridges.hidden = true;
        }
