...
import ru.gov.sfr.aos.monitoring.interfaces.ObjectBuingMapper;
...
import ru.gov.sfr.aos.monitoring.repositories.TerminalSeverModelRepo;
...
public abstract class TerminalServerMapper implements ObjectBuingMapper<TerminalServer, TerminalComponentDto> {
    ...
    @Autowired
    protected TerminalSeverModelRepo terminalServerModelRepo;
    @Autowired
