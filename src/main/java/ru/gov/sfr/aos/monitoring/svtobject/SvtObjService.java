...
public abstract class SvtObjService <E extends ObjectBuingWithSerialAndInventary, T extends ObjectBuingWithSerialAndInventaryRepo, D extends MainSvtDto> {
    ...
    public E getById(Long id) {
      ...
      public void backFromStorage(E objectBuing, Long placeId) {
        ...
        public abstract void createSvtObj(D dto) throws ObjectAlreadyExists, DublicateInventoryNumberException;
        
        public abstract void updateSvtObj(D dto) throws ObjectAlreadyExists, DublicateInventoryNumberException;
