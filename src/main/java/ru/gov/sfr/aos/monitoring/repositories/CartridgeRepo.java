...
public interface CartridgeRepo extends JpaRepository<Cartridge, Long> {
   List<Cartridge> findByPlaceLocationName(String location);
   List<Cartridge> findByPlaceLocationIdAndModelId(Long idLocation, Long idModel, Pageable pageable);
   List<Cartridge> findByPlaceLocationIdAndModelId(Long idLocation, Long idModel);
   List<Cartridge> findByModelId(Long idModel);
   List<Cartridge> findByContractContractNumberAndPlaceLocationIdAndModelId(String contractNumber, Long idLocation, Long idModel, Pageable pageable);
   List<Cartridge> findByContractContractNumberAndPlaceLocationId(String contractNumber, Long idLocation);
   List<Cartridge> findByContractContractNumberAndPrinterModelAndPlaceLocationId(String contractNumber, Long idLocation, Model modelPrinter);
   
   
   @Query(value = "SELECT cart.*, ob.*, cart_print.*, place.*, loc.* "
   + "FROM cartridge cart "
   ...
   @Query(value = "SELECT cart.*, ob.*, contr.*, model.*, place.* "
   + "FROM cartridge cart "
   + "JOIN object_buing ob "
   ...
   @Query(value = "SELECT cart.*, ob.*, contr.*, place.* " +
                    "FROM cartridge cart " +
   ...
   @Query(value = "SELECT cart.*, contr.*, ob.*, model.*, place.* "
   + "FROM cartridge cart "
   + "JOIN object_buing ob "
   + "ON cart.cartridge_id = ob.id "
   + "JOIN place place "
   ...
   + "AND place.location_id = :idLocation "
   + "AND cart.util = FALSE "
   + "AND cart.use_in_printer = FALSE "
   ...
   @Query(value = "SELECT cart.*, ob.*, cart_print.*, p.*, place.* " +
    "FROM cartridge cart " +
    "LEFT JOIN object_buing ob " +
    "ON cart.cartridge_id = ob.id " +
    "LEFT JOIN place place " +
   ...
   @Query(value = "SELECT cart.*, ob.*, contr.*, cart_model.*, cart_manuf.*, place.* " +
                "FROM cartridge cart " +
                "LEFT JOIN object_buing ob " +
                "ON cart.cartridge_id = ob.id " +
                "LEFT JOIN place place " +
   ...
   Page<Cartridge> findByPlaceLocationIdAndContractContractNumberIgnoreCaseLike(Long idLocation, String contractNumber, Pageable pageable);
