...
import ru.gov.sfr.aos.monitoring.interfaces.ManufacturerMapper;
 ...
 */
@Component
public class SystemblockManufacturerMapper implements ManufacturerMapper<SystemBlockManufacturer, ManufacturerDTO, SystemBlockModel>  {
