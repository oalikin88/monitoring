...
INSERT INTO object_buing (contract_id)
VALUES
(SELECT id
...
INSERT INTO printer (inventory_number, printer_status, serial_number, printer_id, location_id, manufacturer_id, model_id)
VALUES 
...
(SELECT id
FROM location WHERE name = 'Склад'),
(SELECT id
...
INSERT INTO cartridge (count, date_end_exploitation, date_start_exploitation, item_code, name_material, use_in_printer, util, cartridge_id, location_id, model_id, printer_id)
VALUES 
